...
const renderHeader: RenderHeader = (row, breakpoint: string) => {
  ...
  if (!/xs/.test(breakpoint)) {
    ...
    header.push(<SecondaryTitle align='center' title='Time'/>)
    header.push(<SecondaryTitle align='center' title='Accuracy'/>)
    header.push(<PrimaryTitle align='center' title='Score'/>)
  }
